...
const ENEMY_BODY_RADIUS_BY_TYPE = Object.freeze({
  scout: REGULAR_ENEMY_BASE_BODY_RADIUS * REGULAR_ENEMY_HITBOX_RADIUS_SCALE,
  normal: REGULAR_ENEMY_BASE_BODY_RADIUS * REGULAR_ENEMY_HITBOX_RADIUS_SCALE,
  tank: 17 * ENTITY_SIZE_SCALE * ENEMY_HITBOX_SCALE_REGULAR * REGULAR_ENEMY_HITBOX_RADIUS_SCALE,
  brute: 17 * ENTITY_SIZE_SCALE * ENEMY_HITBOX_SCALE_REGULAR * REGULAR_ENEMY_HITBOX_RADIUS_SCALE,
  elite: REGULAR_ENEMY_BASE_BODY_RADIUS * REGULAR_ENEMY_HITBOX_RADIUS_SCALE,
